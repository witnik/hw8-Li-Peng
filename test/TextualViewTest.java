...
public class TextualViewTest {
  ...
  public void testViewWithAnime() {
    ...
    model.animate();
    text = new TextualView(model.toString(), 1);
    assertEquals("<html>Shapes:<br>Name: o<br>Type: oval<br>Lower-left corner: " +
            "(30.0,50.0), xRadius: 2.0, yRadius: 3.0, Color: (1.0,5.6,2.3)<br>Appears at" +
            " t=7.0s<br>Disappears at t=220.0s<br><br><br>Name: r<br>Type:" +
            " rectangle<br>Lower-left corner: (10.0,10.0), Width: 5.0, Height:" +
            " 6.0, Color: (3.0,2.3,1.9)<br>Appears at t=10.0s<br>Disappears at" +
            " t=40.0s<br><br><br>Shape o scales from Width: 2.0, Height: 3.0 to" +
            " Width: 30.2, Height: 13.0 from t=8.0s to t=17.0s<br>Shape r moves" +
            " from (10.0,10.0) to (12.0,43.0) from time t=10.0s to t=15.0s<br>Shape" +
            " o changes color from (1.0,5.6,2.3) to (2.1,2.2,2.3) from t=11.0s to" +
            " t=21.0s<br>Shape r scales from Width: 5.0, Height: 6.0 to Width: 12.0," +
            " Height: 50.0 from t=12.0s to t=20.0s<br>Shape o moves from (30.0,50.0)" +
            " to (50.0,250.0) from time t=200.0s to t=220.0s<br></html>", text.toTxt());
  }
}