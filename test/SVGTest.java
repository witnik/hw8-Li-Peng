...
public class SVGTest {
  ...
  /**
   * This is the test that checks whether the SVGView outputs the correct svg output when the model
   * is empty.
   */
  @Test
